...
class ViewController: UIViewController {
    ...
    let quizBank = [
        ...
        ("What is the Model in MVC responsible for?", "Model objects are responsible for the data of our application. It is important to note that Model objects know anything about the user interface. An example of a Model could be a list of questions and answers."),
